     ...
     <div class="row">
         <div class="col-xl-8 col-md-12">
             ...
             <div class="card card-default" data-scroll-height="675">
                 ...
                 <div class="card-body">
                     <canvas id="linechart" class="char.js')}}"></canvas>
                 </div>
                     ...
                     <table class="table ">
                                 ...
                                 <div class="media">
                                     <div class="media-image mr-3 rounded-circle">
                                         <a href="profile.html"><img class="rounded-circle w-45"
                                                                     src="{{asset('backend/assets/img/user/u1.jpg')}}" alt="customer_image"></a>
                                     </div>
                         ...
                         <tr>
                             <td >
                                 <div class="media">
                                     <div class="media-image mr-3 rounded-circle">
                                         <a href="profile.html"><img class="rounded-circle w-45"
                                                                     src="{{asset('backend/assets/img/user/u2.jpg')}}" alt="customer_image"></a>
                                     </div>
                                     <div class="media-body align-self-center">
                         ...
                         <tr>
                             <td >
                                 <div class="media">
                                     <div class="media-image mr-3 rounded-circle">
                                         <a href="profile.html"><img class="rounded-circle w-45" src="{{asset('backend/assets/img/user/u3.jpg')}}"
                                                                     alt="customer_image"></a>
                                     </div>
                                     <div class="media-body align-self-center">
                         ...
                         <tr>
                             <td >
                                 <div class="media">
                                     <div class="media-image mr-3 rounded-circle">
                                         <a href="profile.html"><img class="rounded-circle w-45" src="{{asset('backend/assets/img/user/u4.jpg')}}"
                                                                     alt="customer_image"></a>
                                     </div>
                                     <div class="media-body align-self-center">
                         ...
                         <tr>
                             <td >
                                 <div class="media">
                                     <div class="media-image mr-3 rounded-circle">
                                         <a href="profile.html"><img class="rounded-circle w-45" src="{{asset('backend/assets/img/user/u5.jpg')}}"
                                                                     alt="customer_image"></a>
                                     </div>
                                     <div class="media-body align-self-center">
                 ...
                 <div class="card-body py-0">
                     <div class="media d-flex mb-5">
                         <div class="media-image align-self-center mr-3 rounded">
                             <a href="#"><img src="{{asset('backend/assets/img/products/p1.jpg')}}" alt="customer_image"></a>
                         </div>
                         <div class="media-body align-self-center">
                     ...
                     <div class="media d-flex mb-5">
                         <div class="media-image align-self-center mr-3 rounded">
                             <a href="#"><img src="{{asset('backend/assets/img/products/p2.jpg')}}" alt="customer_image"></a>
                         </div>
                         <div class="media-body align-self-center">
                             <a href="#"><h6 class="mb-3 text-dark font-weight-medium"> Coach Swagger</h6></a>
                             <p class="float-md-right"><span class="text-dark mr-2">20</span>Sales</p>
                     ...
                     <div class="media d-flex mb-5">
                         <div class="media-image align-self-center mr-3 rounded">
                             <a href="#">
                                 <img src="{{asset('backend/assets/img/products/p3.jpg')}}" alt="customer_image"></a>
                         </div>
                         <div class="media-body align-self-center">
