<div class="banner-carousel banner-carousel-1 mb-0">
    <div class="banner-carousel-item" style="background-image:url({{ asset('frontend_new_theme/images/slider-main/bg1.jpg') }})">
    ...
    <div class="banner-carousel-item" style="background-image:url({{ asset('frontend_new_theme/images/slider-main/bg2.jpg') }})">
    ...
    <div class="banner-carousel-item" style="background-image:url({{ asset('frontend_new_theme/images/slider-main/bg3.jpg') }})">
