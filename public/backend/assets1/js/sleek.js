...
$(document).ready(function() {
  ...
  /*======== 2. BACKDROP ========*/
  if ($(window).width() < 768) {
    var shadowClass = $(".mobile-sticky-backendBody-overlay");
    $(".sidebar-toggle").on("click", function() {
      shadowClass.addClass("active");
      $("body").css("overflow", "hidden");
    });

    $(".mobile-sticky-backendBody-overlay").on("click", function(e) {
      $(this).removeClass("active");
      $("#backendBody").removeClass("sidebar-minified").addClass("sidebar-minified-out");
